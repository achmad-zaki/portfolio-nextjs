...
import rubick from '../public/img/RoundCube-Orange-Glossy.png'
import ball from '../public/img/Sphere-White-Matte.png'
import pill from '../public/img/SuperToroid-Purple-Glossy.png'
  ...
  return (
    <div className='container mx-auto w-5/6 flex flex-col-reverse md:flex-col-reverse lg:flex-row items-center min-h-screen pt-24 md:pt-10'>
        ...
        <div className="text-color-white z-10">
            <h1 className='text-color-white font-bold text-3xl lg:leading-[80px] md:text-6xl text-center lg:text-left'>
            ...
            <p className='max-w-lg mx-auto lg:max-w-none text-center my-5 text-color-white font-normal lg:text-left leading-[30px]'>Passionate in Frontend Dev and UI/UX Design. 
